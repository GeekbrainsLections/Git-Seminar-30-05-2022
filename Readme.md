...
Есть несколько способов для получения удаленного репозитория. Можно пользоваться различными сервисами предоставления удаленных репозиториев, самым популярным является **GitHub**. Для полноценной работы с GitHub на нем необходимо зарегистрироваться, для чего надо перейти по адресу https://github.com, в правом верхнем углу нажать кнопку Signin, и ввести свои данные.
1. 
