...
1. Регистрируемся на сайте [GitHub](https://github.com)
2. Создаем новый репозиторий
3. Копируем ссылку на созданный репозиторий
4. В Visual Studio code в терминале пишем следующую команду: *git remote add origin <ссылка на созданный репозиторий>

## Скачивание изменений с удалённого репозитория

Для того, чтобы скачать данные с удаленного репозитория на свой компьютер необходимо в терминале написать следующую команду: *git pull origin <название ветки, которую вы хотите сохранить>*.

## Отправка изменений в удалённый репозиторий

Для того, чтобы отправить изменения в удаленный репозиторий, необходиимо в терминале написать следующую команду:*git push origins <название ветки, которую вы хотите отправить в удаленный репозиторий>*
