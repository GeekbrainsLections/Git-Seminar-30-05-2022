...
Регистрация и создания личного аккаунта на GitHub. Создаем удаленный репозиторий . Далее копируем адрес удаленного репозитрия и на локольном репозитории выполняем команда *git clone <адрес удаленного репозитория>*.
