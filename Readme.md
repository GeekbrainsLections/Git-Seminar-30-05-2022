...
Для работы с репозиторием, необходимо создать его локальную копию.
Чтобы создать локальную копию ипользуется команда __*git clone*__ : 

__*git clone <ссылка_на_репозиторий>*__

__*git clone https://github.com/Chell406/Git-Seminar-30-05-2022.git*__

## Скачивание изменений с удалённого репозитория

Для скачивания изменений репозитория (его текущего актуального состояния) применяется команда __*git pull origin <имя_ветки>*__ :
