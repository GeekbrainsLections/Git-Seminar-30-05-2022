...
Для того чтобы вставить удаленный репозиторий в локальный необходимо нажать вкладку code в GitHub и скопировать ссылку затем в локальном репозитории написать команду *git clone* (ссылка на удаленный репозиторий).

## Скачивание изменений с удалённого репозитория

Для того чтобы скачать изменения с удаленного репозитория необходимо в локальном репозитории прописать команду git pull(имя файла) или git pull origin (имя ветки).
## Отправка изменений в удалённый репозиторий

Для того чтобы отправить изменения в удаленный репозиторий необходимо в локальном репозитории выполнить команду git push (имя файла) или git push origin(имя ветки)
