...
Для того чтобы подключиться к удаленному репозиторию необходимо:

1. Иметь свой аккаунт на [GitHab](https://github.com)
2. Скопировать через кнопку ***Code*** ссылку на удаленный репозиторий 
3. Командой ***git clone "ссылка на репозиторий"*** 
4. Командой ***cd "название папки репозитория"*** (можно ввести первые 4 симовла и нажать клавишу *Tab* для автозаполнения) переходим внутрь пакпи репозитория

## Скачивание изменений с удалённого репозитория
Для скачивания изменений с удаленного репозитория нужно ввести команду ***git pull*** 

## Отправка изменений в удалённый репозиторий
Для того чтобы отправить измененые данные в удаленный репозиторий испоьзуется команда: ***git push***

Если нам необходимо отправить изменения уже в новой созданной ветке то,  чтобы отправить данные в удаленный репозиторий с новой веткой, необходимо ввести команду: ***git origin (нзвание ветки которую мы хотим отправить)***