...
Для скачивания изменения с удаленного репозитория,необходимо ввести команду *git pull*. Для вывода более оптимальной версии.

## Отправка изменений в удалённый репозиторий
Отправка изменений в *GitHub* производится командой *git push* 