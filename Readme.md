...
Для клонирования резитория необходимо скопировать https ссылку репозитория на Git Hub. Далее применить команду в VS Code *git clone* "скопированная ссылка".

## Скачивание изменений с удалённого репозитория
Для скачивания изменений с удаленного репозитория необходимо применить команду *git pull origin master*.

## Отправка изменений в удалённый репозиторий
Для отправки изменений в удаленный репозиторий необходимо применить команду *git push origin master*.
